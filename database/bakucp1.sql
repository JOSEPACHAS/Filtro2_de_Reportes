...
MySQL - 10.4.28-MariaDB : Database - superhero
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`superhero` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
/* Procedure structure for procedure `spu_alignment_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_alignment_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_alignment_listar`()
BEGIN
	SELECT * FROM alignment ORDER BY id;
END */$$
DELIMITER ;

/* Procedure structure for procedure `spu_publisher_alignment_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_publisher_alignment_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_publisher_alignment_listar`(
...
/* Procedure structure for procedure `spu_publisher_height_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_publisher_height_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_publisher_height_listar`(
	IN _publisher_id	INT,
...
/* Procedure structure for procedure `spu_publisher_name_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_publisher_name_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_publisher_name_listar`()
BEGIN
